...
<div className="d-flex flex-column">
    ...
    <Link className="text-decoration-none fw-bold font_size ms-4 mb-3">Egypt</Link>
    <Link className="text-decoration-none font_size ms-4 mb-3">Cairo</Link>
    <Link className="text-decoration-none font_size ms-4 mb-3">Giza</Link>
    <Link className="text-decoration-none font_size ms-4 mb-3">Alexandria</Link>
    <Link className="text-decoration-none font_size ms-4 mb-3">Damietta</Link>
    <Link className="text-decoration-none font_size ms-4 mb-3">Dakahlia</Link>
<Link className="text-decoration-none ms-4 mb-3">View more</Link>
</div>
...
<div>
    ...
    <label htmlhtmlFor="">For Sale</label>
</div>
<div>
    <input type="checkbox" className="checkboxMargin form-check-input"/>
    <label htmlhtmlFor="">Wanted Item</label>
</div>
</div>
<div className="d-flex flex-column border-bottom">
...
<div>
    <input type="checkbox" className="checkboxMargin form-check-input"/>
    <label htmlhtmlFor="">Benzine</label>
</div>
<div>
    <input type="checkbox" className="checkboxMargin form-check-input"/>
    <label htmlhtmlFor="">Diesel</label>
</div>
<div>
    <input type="checkbox" className="checkboxMargin form-check-input"/>
    <label htmlhtmlFor="">Electric</label>
</div>
<div>
    <input type="checkbox" className="checkboxMargin form-check-input"/>
    <label htmlhtmlFor="">Hybrid</label>
</div>
<div>
    <input type="checkbox" className="checkboxMargin form-check-input"/>
    <label htmlhtmlFor="">Natural Gas</label>
</div>
</div>
...
<div>
    <input type="checkbox" className="checkboxMargin form-check-input"/>
    <label htmlhtmlFor="">Cash</label>
</div>
<div>
    <input type="checkbox" className="checkboxMargin form-check-input"/>
    <label htmlhtmlFor="">Installments</label>
</div>
<div>
    <input type="checkbox" className="checkboxMargin form-check-input"/>
    <label htmlhtmlFor="">Exchange</label>
</div>
</div>
<div className="d-flex flex-column border-bottom">
...
<div className="d-flex flex-column border-bottom">
    ...
    <div>
        <input type="checkbox" className="checkboxMargin form-check-input"/>
        <label htmlhtmlFor="">0 to 9999</label>
    </div>
    <div>
        <input type="checkbox" className="checkboxMargin form-check-input"/>
        <label htmlhtmlFor=""> 100000 to 119999</label>
    </div>
    <div>
        <input type="checkbox" className="checkboxMargin form-check-input"/>
        <label htmlhtmlFor="">10000 to 19999</label>
    </div>
    <div>
        <input type="checkbox" className="checkboxMargin form-check-input"/>
        <label htmlhtmlFor="">More than 200000</label>
    </div>
    <div>
        <input type="checkbox" className="checkboxMargin form-check-input"/>
        <label htmlhtmlFor="">120000 to 139999</label>
    </div>
<Link className="text-decoration-none ms-4 mb-3">View more</Link>
</div>
<div className="d-flex flex-column border-bottom">
...
<div>
    <input type="checkbox" className="checkboxMargin form-check-input"/>
    <label htmlhtmlFor="">Automatic</label>
</div>
<div>
    <input type="checkbox" className="checkboxMargin form-check-input"/>
    <label htmlhtmlFor="">Manual</label>
</div>
</div>
<div className="d-flex flex-column border-bottom">
...
<div>
    ...
    <label htmlhtmlFor="">Used</label>
</div>
<div>
    <input type="checkbox" className="checkboxMargin form-check-input"/>
    <label htmlhtmlFor="">New</label>
</div>
</div>
<div className="d-flex flex-column border-bottom">
    ...
    <div>
        <input type="checkbox" className="checkboxMargin form-check-input"/>
        <label htmlhtmlFor="">Black</label>
    </div>
    <div>
        <input type="checkbox" className="checkboxMargin form-check-input"/>
        <label htmlhtmlFor="">White</label>
    </div>
    <div>
        <input type="checkbox" className="checkboxMargin form-check-input"/>
        <label htmlhtmlFor="">Gray</label>
    </div>
    <div>
        <input type="checkbox" className="checkboxMargin form-check-input"/>
        <label htmlhtmlFor="">Blue- Navy Blue</label>
    </div>
    <div>
        <input type="checkbox" className="checkboxMargin form-check-input"/>
        <label htmlhtmlFor="">Silver</label>
    </div>
...
<div>
    <input type="checkbox" className="checkboxMargin form-check-input"/>
    <label htmlhtmlFor="">Sedan</label>
</div>
<div>
    <input type="checkbox" className="checkboxMargin form-check-input"/>
    <label htmlhtmlFor="">SUV</label>
</div>
<div>
    <input type="checkbox" className="checkboxMargin form-check-input"/>
    <label htmlhtmlFor="">Hatchback</label>
</div>
<div>
    <input type="checkbox" className="checkboxMargin form-check-input"/>
    <label htmlhtmlFor="">4X4</label>
</div>
<div>
    <input type="checkbox" className="checkboxMargin form-check-input"/>
    <label htmlhtmlFor="">Coupe</label>
</div>
<Link className="text-decoration-none ms-4 mb-3">View more</Link>
</div>
<div className="d-flex flex-column border-bottom">
    ...
    <div>
    <input type="checkbox" className="checkboxMargin form-check-input"/>
    <label htmlhtmlFor="">1600</label>
</div>
<div>
    <input type="checkbox" className="checkboxMargin form-check-input"/>
    <label htmlhtmlFor="">1400 - 1500</label>
</div>
<div>
    <input type="checkbox" className="checkboxMargin form-check-input"/>
    <label htmlhtmlFor="">1800 - 2000</label>
</div>
<div>
    <input type="checkbox" className="checkboxMargin form-check-input"/>
    <label htmlhtmlFor="">1000 - 1300</label>
    <div>
        <input type="checkbox" className="checkboxMargin form-check-input"/>
        <label htmlhtmlFor="">More than 3000</label>
    </div>
</div>
<Link className="text-decoration-none ms-4 mb-3">View more</Link>
</div>
...
<div>
    <input type="checkbox" className="checkboxMargin form-check-input"/>
    <label htmlhtmlFor="">Air Conditioning</label>
</div>
<div>
    <input type="checkbox" className="checkboxMargin form-check-input"/>
    <label htmlhtmlFor="">AM/FM Radio</label>
</div>
<div>
    <input type="checkbox" className="checkboxMargin form-check-input"/>
    <label htmlhtmlFor="">Power Windows</label>
</div>
<div>
    <input type="checkbox" className="checkboxMargin form-check-input"/>
    <label htmlhtmlFor="">Power Locks</label>
</div>
<div>
    <input type="checkbox" className="checkboxMargin form-check-input"/>
    <label htmlhtmlFor="">Bluetooth System</label>
</div>
<Link className="text-decoration-none ms-4 mb-3">View more</Link>
</div>
<div className="border-bottom">
    ...
    <input type="checkbox" className="checkboxMargin form-check-input"/>
    <label htmlhtmlFor="">Not Available</label>
</div>
<div className="border-bottom">
