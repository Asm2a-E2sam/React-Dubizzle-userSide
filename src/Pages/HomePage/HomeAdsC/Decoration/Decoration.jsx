...
const Decoration = () => {
    return (
        ...
        <div className="col-12 row my-3">
          <div className="col-6 col-md-8 col-lg-10 fs-5 fw-bold">Home Decoration</div>
          <Link className="col-6 col-md-4 col-lg-2 olx-color fw-bold text-decoration-none ps-5">view
            more <FaAngleRight />
          </Link>
        </div>
        <Card style={{ width: '18rem' }}>
      <Card.Img style={{height: '10rem'}} variant="top" src=".././images/imgCardHome/Decoration1.jpeg" />
      <Card.Body>
